...
public class Frame {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 475, 456);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				dx[1] = Double.parseDouble(textField_1.getText());
		...
		JLabel lblNewLabel_13 = new JLabel("m");
		...
		springLayout.putConstraint(SpringLayout.EAST, lblNewLabel_20, -23, SpringLayout.EAST, frame.getContentPane());
